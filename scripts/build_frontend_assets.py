...
def main():
    ...
    manifest = {
        ...
        "source": {
            ...
            "license_status": "provider_confirmed_CC_BY_4_0_public_redistribution_and_transformed_derivatives",
            "license_url": "https://creativecommons.org/licenses/by/4.0/legalcode",
            "terms_url": "https://icv.gva.es/es/condiciones-de-uso-de-la-geoinformacion-icv",
            "copyright_holder": "Generalitat",
        ...
        "publication": {
            ...
            "third_party_licenses_file": "THIRD_PARTY_LICENSES.md",
            "blocking_questions": [],
            "clarification": {
                "received_on": "2026-08-20",
                "channel": "email",
                "authority": "Institut Cartogràfic Valencià",
                "acceptance_mode": "tacit",
                "public_redistribution_confirmed": True,
                "transformed_derivatives_confirmed": True,
                "modification_notice_required": True,
                "attribution_to": "Generalitat",
                "provider_proposed_attribution": "Incendios forestales de la Comunitat Valenciana (1993–2024) CC BY 4.0, Generalitat. Datos transformados para su visualización mediante reproyección, selección de atributos, particionado y simplificación geométrica.",
            },
            "note": "El ICV confirmó por correo la redistribución pública bajo CC BY 4.0, la aceptación tácita y la publicación de transformaciones si se indican. Los assets aún no se han publicado ni añadido a Git.",
        },
        "zoom_levels": {
