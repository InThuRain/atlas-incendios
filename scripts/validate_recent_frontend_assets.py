...
def main():
    ...
    with tempfile.TemporaryDirectory() as directory:
        ...
        if set(public_manifest["sources"]) != {"egif", "esfire30", "icv", "effis"} or public_manifest["icv"] is None or public_manifest["egif"] is None or public_manifest["esfire30"] is None:
            fail("Public profile does not contain the publishable EGIF, ESFire30, ICV and EFFIS sources")
