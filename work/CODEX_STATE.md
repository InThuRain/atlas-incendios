...
PHASE = ES-4POST4_PRODUCTION_PATCH_STAGING

STATUS = DONE (TAR POST2 exacto publicado como prerelease inmutable y desplegado sólo en GitHub Pages staging; identidad, Range, glyphs, popup, solapes, temporal, móvil y enlaces aceptados remotamente; producción no modificada).
...
STAGING_PATCH_RELEASE = national-product-post2-staging-es4post4

STAGING_PATCH_ASSET = national-product-post2-patch.tar.gz

STAGING_PATCH_TAR_BYTES = 431670756

STAGING_PATCH_TAR_SHA256 = 8903bc91de088e82b7c3410d6b2d2e0a5eda64889ffdcc02569319fcc14e45af

STAGING_WORKFLOW_RUN_ID = 34528201012

STAGING_PAGES_ARTIFACT_ID = 10172427825

STAGING_PAGES_DEPLOYMENT_ID = 6380784035

REMOTE_PATCH_ASSET_MANIFEST_SHA256 = 557c662dd23df2207f68b6ef36ddae35f0d06b069864ffbb8b3b53ded7a59bd0

REMOTE_PATCH_SITE_IDENTITY_SHA256 = f8fe88d66313931d2ed318723334d45062f23cc72f86538835a6df638ba785a1

PRODUCTION_PRE_POST2_SITE_IDENTITY_SHA256 = f5e80a728f45057692f36ba41f76900c9d00b9c962cedc4eb591e29e813da04e

PRODUCTION_UNCHANGED = true

RESULTS_PATH = ES_4POST4_PRODUCTION_PATCH_STAGING.md; data/audit/product/es4post4_production_patch_staging.json

NEXT_PHASE = ES-4POST5_PRODUCTION_PATCH_EXECUTION

PHASE = ES-4POST5_PRODUCTION_PATCH_EXECUTION

STATUS = DONE (parche POST2 desplegado desde TAR fijo; gates locales, runner e identidad/aceptación remota PASS; commit de cierre sólo local, sin tag ni inicio de POST6).
...
ROLLBACK_REQUIRED = false
PRE_POST2_ROLLBACK_STATUS = READY
MAIN_COMMIT = 534cfe37a7120904f48c87bba71b4fcb7423bb5f
PATCH_WORKFLOW_RUN_ID = 34620607559
PAGES_ARTIFACT_ID = 10271688978
PAGES_DEPLOYMENT_ID = 6397065009
...
RELEASE_TAG_RECOMMENDATION = national-product-v1.0.0
...
PHASE = ES-4HOT1_MAP_CLICK_ROUTING_HOTFIX
STATUS = DONE_LOCAL (causa reproducida con gestos CDP reales en producción; árbitro exclusivo y regresiones locales correctos; sin push/deploy/tag).
POST_RELEASE_BACKLOG = PAUSED_FOR_CLICK_ROUTING_HOTFIX
PRODUCTION_CLICK_ROUTING = FAIL
DIRECT_CLICK_PRODUCTION = FAIL
BASIC_POPUP_PRODUCTION = FAIL
...
ROOT_CAUSE = COMPETING_CLICK_HANDLERS + STATE_INVALIDATION_AFTER_FIRE_CLICK
PRODUCTION_REPRODUCTION = 7/7 failed as expected
LOCAL_CLICK_CASES = 10/10 PASS
LOCAL_FILTER_VISIBILITY_PERIOD_CASES = 3/3 PASS
FOCUSED_TESTS = 21 PASS; additional province legacy tests 2 PASS / 1 blocked by system Node10 optional chaining support
POINT_QUERY_MODE = legacy GVA preserved; absent in national v1.0.0; arbiter precedence unit-tested, no new tool implemented
ISOLATED_PRODUCTION_SUCCESS_CASE = not reproduced; bounded coastal no-admin-hit search found no point
RELEASE_TAG = national-product-v1.0.0
RELEASE_TAG_STATUS = UNCHANGED_IMMUTABLE
RELEASE_TAG_TARGET = 534cfe37a7120904f48c87bba71b4fcb7423bb5f
RECOMMENDED_HOTFIX_VERSION_AFTER_STAGING_AND_PRODUCTION = national-product-v1.0.1
PUSH = false
DEPLOY = false
TAG_CREATED = false
